...
public class TextActionBar extends RelativeLayout implements OnClickListener {
    ...
    public TextActionBar(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public void setHomeAction(DrawableAction action) {
    ...
    private View inflateAction(Action action) {
        ...
        if (action instanceof DrawableAction) {
            ...
            labelView.setImageResource(((DrawableAction) action).getDrawable());
        } else if (action instanceof TextAction) {
            view = mInflater.inflate(com.jk.aliencontacts.R.layout.actionbar_text_item, mActionsView, false);
            TextView labelView = (TextView) view.findViewById(com.jk.aliencontacts.R.id.actionbar_text_item);
            labelView.setText(((TextAction) action).getText());
        }
    ...
    public static abstract class IntentAction implements Action {
    ...
    public static class DrawableAction extends IntentAction {
        final private int mDrawable;

        public DrawableAction(Context context, Intent intent, int drawable) {
    ...
    public static class TextAction extends IntentAction {
        final private String mText;

        public TextAction(Context context, Intent intent, String text) {
            super(context, intent);
            mText = text;
        }
